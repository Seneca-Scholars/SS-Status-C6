...
# 09/17/2025
In the morning I finished taking notes on advanced types in typescript and I came up with scenarios where they would become necessary for ScholarScout. I also answered the questions from Jaime on SQL, CRUD, and Server responses. I then met with Nell to discuss my needs assessment and updated responses for around an hour. I also wanted to brush up on my Figma skills to better contribute to the Design team so I watched a couple of tutorial videos on how to best utilize the platform! I then practiced with Typescript by creating a quick todo list project that applied the more advanced types I read and watched tutorials about so that I can better grasp the language. However, I ran into an error that needed debugging as one of my import statments was conflicting. I learned the issue was not with the code/syntax itself but rather with how my paths were set up, thus I was attempting to access a file outside the scope of the one I was working within. I then set up the front end components and attempted to connect the front+back end and run the app, going through my files and ensuring I understood what was happening in each line of code, noting pieces I wanted to circle back to. I was working in the office from 9:30 am to 2:30 pm. 
...
# 07/01/2025
Tuesday we went over javascript fundamentals and I practiced rebasing more with main and my separate branch. I also learned the purpose of case structures and how to define classes and create classes. 

# 06/30/2025
Today, we had two lessons on html and rebasing. I learned the steps to rebase and why we use it: to solve merge conflicts and to pull information from main to our branch. Also, I worked on writing some basic notes on html from the url on its syntax Wa-jiw sent on Slack. I learned also the different purposes in website building for html, css, dom, and javascript where some are meant as a stable program and others allow the website to be interactive. 

# 06/27/2025
Today we worked on discovering our leadership annd learnng styles through in depth quizzes and results analysis. We also worked individually with Nell to understand our financial aid packages from our respective universities.  

# 06/26/2025
This thursday, I practiced opening an application with yarn and node installations. Then, I made changes to the page.tsx file in the nextjs-practice branch and committed those changes and made a pull request.

# 06/25/2025
On wednesday, I created my very basic linkedin profile that I will continue to improve with Nell in the days to come so that I can market my skills and accomplishments so far. I also disected what I want to add to my linkedin to get it to my ideal profile vision. I also engaged in discussion with my Cohort 6 peers on thoughts on the college journey.  

# 06/24/2025
Today I practiced creating my own repo in github, creating a remote for it in the terminal, pushing subfolders and files to the main, and making pull requests. I also learned that sometimes it will cause an issue to commit an empty subfolder or folder in general so its best to create a file within them. Also, I learned some basic commands with git such as git log to check commits, and git status to check the status.

# 06/23/2025
Today I want to investigate more into the basic command modifiers that we can use in the terminal that start with a dash, such as -b. I also want to prepare for tomorrow's lesson on pull requests and what they are, how they work. Then the third investigation I want to commence is on html basics because I have never learned that language before in school or in any other classes and I would like to be at the same level as my cohort peers for when we start working with html. I also learned I should save the previous status updates instead of replacing them with the current day's update. 
